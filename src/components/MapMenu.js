...
const MapMenu = ({
  ...
  const displayPrintSelection = selection.length === 1
    ? `Carte ${selection[0]} ${cadastre ? 'avec affichage du cadastre' : ''}`
    : `À gauche: carte ${selection[0]} ${cadastre ? 'avec affichage du cadastre' : ''}; À droite: carte ${selection[1]}`;
